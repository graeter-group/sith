...
print_help() {
echo "
Creates the com files from the xyz structures extracted from a gaussian log file and
...
source $(sith basics -path) "AfterOpt2" $verbose
